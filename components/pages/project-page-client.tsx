...
export function ProjectPageClient({ slug }: { slug: string }) {
      ...
      <main className="min-h-screen">
        ...
        <div className="container pt-40">
          ...
          <p className="mt-4 text-muted-foreground">
            This case study does not exist yet in Firestore.
          </p>
  ...
  const hasRealImages = project.images.some(
    (img) =>
      img.includes(".png") ||
      img.includes(".jpg") ||
      img.includes(".jpeg") ||
  ...
  return (
    <main className="min-h-screen pb-20">
      ...
      <div className="container">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              {project.links.map((link) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex items-center gap-2 rounded-full border border-white/12 bg-white/[0.06] px-4 py-2 text-sm transition hover:border-primary/40 hover:bg-primary/10"
                >
                  {link.label}
        ...
        <section className="mt-12 space-y-5">
          {project.sections.map((section, index) => (
            ...
            >
              ...
              <h2 className="mt-4 font-display text-2xl md:text-3xl">{section.title}</h2>
        ...
        {hasRealImages && project.images.length > 0 ? (
        ...
        <section className="mt-12 overflow-hidden rounded-2xl border border-white/15 bg-gradient-to-r from-[#6e58c9]/25 to-[#ff85cc]/15 p-7 md:p-10">
          <p className="text-[10px] uppercase tracking-[0.2em] text-primary">Impact</p>
